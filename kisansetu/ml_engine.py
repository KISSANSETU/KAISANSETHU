...
# KisanSetu should still start and use the remaining forecasting models.
try:
    ...
    print("  KisanSetu will continue without XGBoost.")
...
DB_PATH = os.path.join(BASE_DIR, "kisansetu.db")
