...
# We do not need another primary Maharashtra account.
    ...
    for listing_index, crop in enumerate(
        ...
        """, (
            ...
            (
                f"KisanSetu Link India demo produce "
                f"from {city}, {state}. "
...
notes = [
    ...
    (
        ...
        "KisanSetu detected higher expected farmer realization in nearby markets.",
        "success"
    ),
...
print()
print("==============================================")
print("KisanSetu DATABASE SEEDED SUCCESSFULLY")
print("==============================================")
