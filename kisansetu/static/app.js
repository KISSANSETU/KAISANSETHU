...
function setLanguage(v){currentLang=v;window.currentLang=v;localStorage.setItem('gram_lang',v);fillLangs();document.documentElement.lang=v;document.querySelectorAll('[data-i18n]').forEach(e=>e.textContent=tr(e.dataset.i18n));if(me){renderNav();route(currentPage||'dashboard')}if(window.I18N)window.I18N.setLang(v).then(()=>{if(window.GramSaathi)window.GramSaathi.onLanguageChange()});else if(window.GramSaathi)window.GramSaathi.onLanguageChange()}
...
const NAV={farmer:[['dashboard','🏠'],['crops','🌾'],['market','🧺'],['preorders','🤝'],['transport','🚚'],['paymentsRewards','💳'],['profile','👤'],['feedback','⭐'],['grievances','🛡'],['linkIndia','🗺'],['mspDistress','🛡'],['chats','💬']],buyer:[['dashboard','🏠'],['discover','🌾'],['preorders','📅'],['orders','📦'],['bulk','👥'],['rewards','🎁'],['profile','👤'],['feedback','⭐'],['grievances','🛡'],['connectBuyers','🗺'],['mspDistress','🛡'],['chats','💬']],admin:[['dashboard','📊'],['usersKyc','🪪'],['markets','🌐'],['payments','💳'],['grievances','🛡'],['stateAnalytics','📈'],['feedbackReq','💬'],['securityActions','🔐']]};
...
function setTitle(k){currentPage=k;$('pageTitle').textContent=tr(k);$('breadcrumb').textContent=`KisanSetu • ${me.role==='farmer'?'Maharashtra':currentState}`;renderNav()}
...
async function farmerRoute(k){
  ...
  if(k==='mspDistress')return MSPDistress.renderFarmerPage();
    ...
    return `
      ...
      <div class="crop-step-panel">
        ...
        <p class="step-description">
          ...
          KisanSetu will automatically analyse the produce
    ...
    if ($('verifyResult')) {
      ...
      $('verifyResult').innerHTML = `
        ...
        <div class="ai-processing">
          ...
          🤖 KisanSetu is analysing the produce image...
...
async function publishVerifiedCrop() {
  ...
  try {
    ...
    if (
      ...
      throw new Error(
        'Complete KisanSetu quality verification first'
      );
    ...
    await api(
...

      {
        ...
        body: JSON.stringify({
          ...
          quality_notes:
            'Live GPS + image verified by KisanSetu'
...
/* =========================================================
   KisanSetu REVIEW FOR EACH MARKET
========================================================= */
...
/* =========================================================
   FARMER FORECAST + KisanSetu RECOMMENDATION
========================================================= */
...
async function runFarmerForecast() {
  ...
  try {
    ...
    if (
      ...
      recommendationSentence =
        ...
        difference > 0
          ...
          ? `WAIT: KisanSetu expects ${crop} to improve by approximately ${fmt(difference)} per quintal over the forecast period.`

          : `WAIT: KisanSetu recommends waiting based on the current market trend and expected net realization.`;
    ...
    $('forecastResult').innerHTML = `
      ...
      <!-- FINAL KisanSetu RECOMMENDATION -->
      ...
      <div class="offer-confirm-page">
        ...
        <div class="confirm-card">
          ...
          <div class="token-rule-box">
            ...
            <b>
              🔒 KisanSetu Secure Acceptance Rule
            </b>
      ...
      <div class="farmer-rewards-page">
        ...
        <div class="fr-hero">
          ...
          <div class="fr-hero-content">
            ...
            <h2>
              KisanSetu Profit & Rewards
            </h2>

            <p>
              KisanSetu does not reward you only for using
          ...
          <div class="fr-section-head">
            ...
            <div>
              ...
              <div>
                ...
                <p>
                  Measures whether KisanSetu decisions
          ...
          <div class="fr-profit-grid">
            ...
            <div class="fr-profit-summary">
              ...
              <div class="fr-income-row">
                ...
                <span>
                  Estimated net without KisanSetu
                </span>
          ...
          <div class="fr-section-head">
            ...
            <div>
              ...
              <div>
                ...
                <p>
                  KisanSetu rewards verified farmer outcomes,
...
">
  ✨ NEW FEEDBACK MODE
        ...
        <div class="ff-impact-card">
          ...
          <p>
            Suggest what KisanSetu should build next and track
        ...
        <div class="ff-section-head">
          ...
          <div>
            ...
            <div>
              ...
              <p>
                Tell us which part of KisanSetu helped you
      ...
      <div class="ff-section">
        ...
        <div class="ff-section-head">
          ...
          <div>
            ...
            <div>
              <h3>
                Did KisanSetu's Recommendation Help?
              </h3>
      ...
      <div class="ff-section">
        ...
        <div class="ff-section-head">
          ...
          <div>
            ...
            <div>
              ...
              <p>
                Tell KisanSetu when the real market differs
                from our data.
              </p>
            </div>
        ...
        <div class="ff-ground-note">
          ...
          <div>
            ...
            <p>
              Verified farmer reports can help KisanSetu detect
        ...
        <div class="ff-section-head">
          ...
          <div>
            ...
            <div>
              ...
              <h3>
                Vote: What Should KisanSetu Improve Next?
              </h3>

              <p>
                Vote for the next advanced capability you want KisanSetu to improve or add to the platform.
              </p>
          ...
          <div class="field full">
            ...
            <div class="ff-voice-input">
              ...
              <textarea
                ...
                class="control"
                rows="5"
                placeholder="Tell KisanSetu what happened, what should improve, or what farmers in your area need..."
              ></textarea>
      ...
      <div class="ff-section">
        ...
        <div class="info-panel">
          ...
          <p>
            ...
            suggestion, KisanSetu can notify you instead of
    ...
    const result = await api(
      '/api/v2/feedback',
      {
        ...
        body: JSON.stringify({
          ...
          message:
            finalMessage ||
            'Farmer feedback submitted through KisanSetu',
    ...
    <div class="farmer-feedback-page">
      ...
      <div class="ff-hero">
        ...
        <div class="ff-hero-copy">
          ...
          <h2>
            Help Improve KisanSetu Procurement
          </h2>
      ...
      <div class="ff-section">
        ...
        <div class="ff-section-head">
          ...
          <div>
            ...
            <div>
              ...
              <p>
                Tell us whether KisanSetu helped
        ...
        <div class="ff-form-grid">
          ...
          <div class="field">
            ...
            <label>
              Did KisanSetu help you find the right farmer?
            </label>
        ...
        <div class="ff-section-head">
          ...
          <div>
            ...
            <div>
              ...
              <h3>
                What Should KisanSetu Improve for Buyers?
              </h3>
      ...
      await api(
        '/api/v2/feedback',
        {
          ...
          body: JSON.stringify({
            ...
            message:
              finalMessage ||
              'Buyer feedback submitted through KisanSetu',
                    ...
                    ? `
                      ...
                      <div class="gr-ai-resolution">
                        ...
                        <div>
                          ...
                          <b>
                            KisanSetu Resolution Assistant
                          </b>
            ...
            <div class="gr-ai-resolution">
              ...
              <div>
                ...
                <p>
                  ${esc(
                    g.ai_recommendation ||
                    'KisanSetu will analyse the seller, order, payment and evidence history.'
                  )}
                </p>
        ...
        <div class="gr-form-card">
          ...
          <div class="gr-form-grid">
            ...
            <div class="field">
              ...
              <div class="gr-auto-severity">
                🤖 KisanSetu automatically determines
      ...
      <div class="state-market-page">
        ...
        <div class="state-market-hero">
          ...
          <div>
            ...
            <span>
              🇮🇳 KisanSetu State Market Network
            </span>
      ...
      $('stateMarketList').innerHTML = `
        ...
        <div class="empty">
          ...
          <small>
            ...
            can be added to the KisanSetu database.
    ...
    $('modalBody').innerHTML = `
      ...
      <div class="state-market-modal">
        ...
        <div class="security-note">
          ...
          currently available in KisanSetu.
      ...
      <div class="buyer-discover-page">
        ...
        <div class="discover-hero">
          ...
          <div>
            ...
            <span class="verified-badge">
              ✓ KisanSetu Verified Marketplace
            </span>
  ...
  try {
    ...
    holder.innerHTML = `
      ...
      <div class="info-panel">
        ...
        calculated securely by KisanSetu
...
function reviewBulkOrder() {
  ...
  $('content').innerHTML = `
    ...
    <div class="card">
      ...
      <div class="alert">
        After creation, KisanSetu will generate a unique
...
window.currentLang=currentLang;fillLangs();setLanguage(currentLang);selectRole(activeRole);if(token){api('/auth/me').then(x=>{me=x;boot()}).catch(()=>logout())}

/* Mobile navigation drawer. The sidebar overlays content below 900px, so it
   must close on navigation, on scrim tap and on Escape. */
function setNav(open){document.body.classList.toggle('nav-open',open);
 let sc=$('navScrim');if(sc)sc.classList.toggle('hidden',!open)}
function toggleNav(){setNav(!document.body.classList.contains('nav-open'))}
document.addEventListener('DOMContentLoaded',()=>{
 let t=$('navToggle');if(t)t.onclick=toggleNav;
 let sc=$('navScrim');if(sc)sc.onclick=()=>setNav(false);
 let nv=$('nav');if(nv)nv.addEventListener('click',e=>{if(e.target.closest('.nav-btn'))setNav(false)});
