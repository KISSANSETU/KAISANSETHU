...
LOCAL_DB = os.path.join(BASE_DIR, "gramai.db")
...
def _local_fallback(crop_title: str):
    """Highest/lowest price from GramAI's own seeded prices/markets tables -
...
def compare_prices(crop: str) -> dict:
    ...
    or unreachable does this fall back to GramAI's own seeded data, always
